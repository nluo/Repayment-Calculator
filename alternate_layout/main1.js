$(function() {
	...
	$( "#_interest_slider" ).slider({
		...
		slide: function(event,ui){
			var rate=ui.value;
			$("#loan_interest").val(rate)}
	});
	
	$("#loan_year").change(function () {
    	var result1 = $("#loan_year").val();
		$("#loan_year").val(result1);
    	$("#_mortgage_slider").slider('value', result1);
	});
		
		
	$("#loan_interest").change(function () {
    	var result2 = $("#loan_interest").val();
		$("#loan_interest").val(result2);
    	$("#_interest_slider").slider('value', result2);
	});
